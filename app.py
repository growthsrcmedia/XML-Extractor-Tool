...
def inject_botpresso_css():
    ...
    <style>
        /* Typography: Inter (loaded via link above) – weights Heavy(900), Bold(700), Medium(500), Regular(400), Thin(300); styles H1–H6, Body, Caption, Small, Tiny */
        ...
        /* Botpresso Theme - Root Level + Typography (Inter) */
        html, body {{
        ...
        /* Base font family - Typography (Inter) site-wide */
        *, .stMarkdown, .stMarkdown *, [data-testid="stAppViewContainer"], .main, .main * {{
            font-family: var(--font-family) !important;
        }}
        
        /* Heading 1 - Multiple weights (Heavy/Bold/Medium/Regular/Thin) */
        h1 {{
        ...
        /* Typography utility classes (Heading 1–6, Body, Caption, Small, Tiny) for use in markdown/custom HTML */
        .heading-1 {{ font-size: 2.5rem !important; line-height: 1.2 !important; font-weight: 700 !important; letter-spacing: -0.02em !important; font-family: var(--font-family) !important; }}
        .heading-2 {{ font-size: 2rem !important; line-height: 1.3 !important; font-weight: 600 !important; letter-spacing: -0.01em !important; font-family: var(--font-family) !important; }}
        .heading-3 {{ font-size: 1.75rem !important; line-height: 1.3 !important; font-weight: 600 !important; font-family: var(--font-family) !important; }}
        .heading-4 {{ font-size: 1.5rem !important; line-height: 1.4 !important; font-weight: 600 !important; font-family: var(--font-family) !important; }}
        .heading-5 {{ font-size: 1.25rem !important; line-height: 1.4 !important; font-weight: 600 !important; font-family: var(--font-family) !important; }}
        .heading-6 {{ font-size: 1.125rem !important; line-height: 1.4 !important; font-weight: 600 !important; font-family: var(--font-family) !important; }}
        .text-body {{ font-size: 1rem !important; line-height: 1.5 !important; font-weight: 400 !important; font-family: var(--font-family) !important; }}
        .text-caption {{ font-size: 0.875rem !important; line-height: 1.4 !important; font-weight: 400 !important; font-family: var(--font-family) !important; }}
        .text-small {{ font-size: 0.8125rem !important; line-height: 1.4 !important; font-weight: 400 !important; font-family: var(--font-family) !important; }}
        .text-tiny {{ font-size: 0.75rem !important; line-height: 1.4 !important; font-weight: 400 !important; font-family: var(--font-family) !important; }}
        
        /* Apply typography to Streamlit text widgets site-wide */
        [data-testid="stMarkdown"] p, [data-testid="stMarkdown"] li, [data-testid="stMarkdown"] span,
        [data-testid="stMetricLabel"], [data-testid="stMetricValue"], .stCaption, label, .stTextInput label,
        .stSelectbox label, .stCheckbox label, .stNumberInput label {{
            font-family: var(--font-family) !important;
        }}
        
        /* Typography on inputs, selects, buttons (Body/Regular style) */
        .stTextInput input, .stSelectbox select, .stNumberInput input, .stButton button,
        input, select, button {{
            font-family: var(--font-family) !important;
        }}
        ...
        /* Completely remove left sidebar */
        [data-testid="stSidebar"],
        [data-testid="stSidebar"] > div,
...
def get_site_structure(urls: List[str]) -> List[Tuple[str, int, float]]:
    """
    Group URLs by top-level path and return (path, page_count, percentage).
    Path is the first path segment as /segment/. Root or empty paths go to "Other".
    """
    ...
    if total == 0:
        return []
    return [
        (path, count, round(100.0 * count / total, 1))
    ...
    if extract_button:
        ...
        try:
            ...
            with results_container:
                ...
                # Site Structure snapshot (path, pages, percentage)
                if sorted_urls:
                    structure = get_site_structure(sorted_urls)
                    if structure:
                        st.subheader("Site Structure")
                        structure_df = pd.DataFrame(
                            [
                                {"Site Structure": "▸ " + path, "Pages": count, "Percentage": f"{pct}%"}
                                for path, count, pct in structure
                            ]
                        )
